...
package Converters::Passpack 1.00;
...
sub do_import {
	...
	my ($card_title, $card_notes, $card_tags) = @$row{qw/title notes tags/};
...
sub do_export {
    add_new_field('login',        'email',  'other.Other Information', $Utils::PIF::k_string, 'email');
    create_pif_file(@_);
}
